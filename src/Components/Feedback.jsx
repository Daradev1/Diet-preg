...
const FeedbackForm = () => {
  return (
    <div className="flex flex-col md:flex-row justify-center gap-2 items-center md:items-start p-6 md:p-12 min-h-screen">
      ...
      <form className="md:w-1/2 w-full h-full md:h-full bg-white shadow-lg rounded p-4 ">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm font-medium text-gray-700">Name</label>
            <div className="relative mt-1">
              <input  required type="text" className="w-full border border-gr focus:ring-button ay-300 rounded-full p-2 shadow-md focus:ring-button focus:border-button" placeholder="John Doe" />
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input  required type="email" className="w-full border border-g focus:ring-button ray-300 rounded-full p-2 shadow-md focus:ring-button focus:border-button" placeholder="Email address" />
              <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-2">
          <div>
            ...
            <div className="relative mt-1">
              <input  required type="text" className="w-full border  rounded-full p-2 shadow-md focus:ring-pink-500 focus:border-pink-500" placeholder="(123) 456-7890" />
              <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
          ...
          <div>
            ...
            <div className="relative mt-1">
              <input  required type="text" className="w-full border  focus:ring-button rounded-full p-2 shadow-md  focus:border-pink-500" placeholder="Your age" />
              <div className="absolute inset-y-0 right-0 pr-3 flex items-center">
        ...
        <div>
          ...
          <div className="flex space-x-2 mt-2">
            {[...Array(5)].map((_, index) => (
              <span key={index} className={`text-${index < 3 ? 'yellow' : 'gray'}-400 text-2xl`}>&#9733;</span>
            ))}
          </div>
        </div>
        ...
        <div className="flex items-start my-2">
          <input  required type="checkbox" className="h-4 w-4 text-button focus:ring-button  border-gray-300 rounded" />
