...
<h2 className='font-bold text-pink-600 underline'>ABOUT US</h2>
</div>
...
<b className='text-white p-2 bg-pink-600 text-center rounded-lg'>Enter your age</b>
<b className='text-white  p-2 bg-pink-600 text-center rounded-lg'>Input your weight</b>
</div>
</div>
</div>
<div className='flex-col w-full mb-20 flex justify-center items-center'>
<b className='text-pink-600 text-center'> Know Your Diet</b>
<b className='text-pink-600 text-center'> Breakfast/Lunch/Dinner</b>
